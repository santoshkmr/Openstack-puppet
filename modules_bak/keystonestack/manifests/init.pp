...
$host     = $keystonestack::params::host,
) inherits keystonestack::params

{
$randomid = generate("/usr/bin/openssl", "rand", "-hex 10")
$pkgs     = ['python-openstackclient', 'rabbitmq-server', 'memcached', 'python-memcache', 'mariadb-server', 'python-pymysql', 'keystone', 'apache2', 'libapache2-mod-wsgi']
exec {
 'AddRepos':
